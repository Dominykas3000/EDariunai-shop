      ...
      <div className="flex flex-col items-center justify-center w-full h-full">
        ...
        <div className="flex mt-4">
          <Link href="/popularItems">
            <button className="w-full text-white bg-gray-900 hover:bg-gray-800 font-medium rounded-lg text-base px-5 py-2.5 text-center dark:gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-800">View popular items!</button>
          </Link>
        </div>
