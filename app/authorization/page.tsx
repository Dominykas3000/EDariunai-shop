...
const AuthorizationPage = () => {
  ...
  let googleButton = (
    <button
      ...
      className="flex items-center bg-white border border-button-border-light rounded-md p-0.5 pr-3 w-full justify-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    >
      ...
      <FormSection>
        ...
        <div className="pt-[12px] text-m font-medium text-gray-500 dark:text-gray-300">
          ...
          <a
            ...
            className="text-gray-800 hover:underline dark:text-blue-600 dark:hover:text-blue-700 dark:focus:ring-blue-800">
